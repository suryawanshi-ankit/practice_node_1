...
router.get('/', auth, asyncTryCatchMiddleware(async(req, res) => {
...
router.delete('/:id', auth, asyncTryCatchMiddleware(async(req, res) => {
...
router.patch('/:id', auth, asyncTryCatchMiddleware(async(req, res) => {
